...
CORS is restricted to the origins listed in the `FRONTEND_ORIGINS` environment
variable. Adjust it if you need to allow additional domains.
...
| `GET /`                     | basic index returning `{status:"ok"}` |
